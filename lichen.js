...
var MessageDisplay = new Class({
	...
	_render: function( message, forceType ) {
		...
		var htmlFragment = "<div class=\"header-bar\"><img src=\"theme/top-corner.png\" alt=\"\" id=\"top-corner\" />";
		...
		htmlFragment += "<div class=\"footer-bar\"><img src=\"theme/bottom-corner.png\" alt=\"\" id=\"bottom-corner\" />" + messageNavBar + "</div>";
...
function list_twiddleFlagCB( responseText ) {
	...
	if ( result.flag == 'seen' ) {
		...
		for ( var i = 0; i < uidsAffected.length; i++ ) {
			...
			if ( flagIcon ) {
				if ( result.state ) {
					flagIcon.src = 'theme/icons/' + result.flag + '.png';
				} else {
					flagIcon.src = 'theme/icons/un' + result.flag + '.png';
				}
			}
		}
	}
...
function list_sort( sort ) {
	...
	if ( oldImg ) {
		oldImg.src = 'theme/icons/blank.png';
	}
...
//	var msgTable = new Element('table', { 'id': 'tablefoo' });
	...
	tableContents += "<div class=\"header-bar\"><img src=\"theme/top-corner.png\" alt=\"\" id=\"top-corner\" />" + pageSwitchBar + "</div>";
	...
	tableContents += "<th><a href=\"#sort-from\" onclick=\"list_sort('from'); return false\">Sender</a><img src=\"theme/icons/blank.png\" id=\"sort_from_dir\" /></th>"; // Sender
	tableContents += "<th><a href=\"#sort-subject\" onclick=\"list_sort('subject'); return false\">Subject</a><img src=\"theme/icons/blank.png\" id=\"sort_subject_dir\" /></th>"; // Subject
	if ( userSettings['list_showsize'] ) {
		tableContents += "<th><a href=\"#sort-size\" onclick=\"list_sort('size'); return false\">Size</a><img src=\"theme/icons/blank.png\" id=\"sort_size_dir\" /></th>"; // Size
	}
	tableContents += "<th><a href=\"#sort-date\" onclick=\"list_sort('date'); return false\">Date</a><img src=\"theme/icons/blank.png\" id=\"sort_date_dir\" /></th>"; // Date
	tableContents += "</tr>";
...
//		var msgRow = createListRow( thisMsg );
		...
		thisRow += "<img src=\"theme/icons/seentoggle.png\" /></a></td>";

		if ( userSettings['list_showflagged'] ) {
			var flagImage = thisMsg.flagged ? "theme/icons/flagged.png" : "theme/icons/unflagged.png";
...
//		new Drag.Base(msgRow, {});
	...
	tableContents += "</table>";
	tableContents += "<div class=\"footer-bar\"><img src=\"theme/bottom-corner.png\" alt=\"\" id=\"bottom-corner\" />" + pageSwitchBar + "</div>";
	...
	if ( listCurrentSort.substr( listCurrentSort.length - 2, 2 ) == "_r" ) {
		...
		if ( newImg ) newImg.src = 'theme/icons/sortup.png';
	} else {
		// Forward.
		var newImg = $('sort_' + listCurrentSort + '_dir');
		if ( newImg ) newImg.src = 'theme/icons/sortdown.png';
	}
