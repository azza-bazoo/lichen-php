...
// Name, port, and external domain of the SMTP server that Lichen will use
// to send mail. This port is usually 25, 465 (secure), or 587.
// The domain is the part after @ in your return e-mail address.
...
// Name of the IMAP server that Lichen will be using.
...
// By default, unencrypted port 143 will be used when the server is localhost
// and SSL on port 993 will be used for any other server.
